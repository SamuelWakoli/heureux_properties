              ...
              onPressed: () async {
                if (image != null) {
                  ...
                  await FirebaseStorage.instance
                      .ref("property images")
                      .child("$propertyID/image 2.png")
                      .putFile(image!)
                      .then((snapshot) {
                    img2URL = snapshot.ref.getDownloadURL().toString();
                  }).whenComplete(() async {
                    // upload image url
                    if (img2URL != null) {
                      Map<String, dynamic> data = {"img 2 URL": img2URL};
                      await FirebaseFirestore.instance
                        ...
                        return nextPage(
                            context: context, page: const AddListingImg3());
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                        content: Text(
                            'Please add second image for the property to continue')),
                  );
                }
              },
              child: loading
